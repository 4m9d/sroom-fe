...
export default function HorizontalBigLectureCard({
  ...
  return (
    <div className='relative flex w-full gap-5 p-3 overflow-hidden whitespace-normal bg-white lg:gap-8'>
      ...
      <div className='w-full min-h-full overflow-hidden whitespace-normal'>
        {children}
      </div>
    </div>
  );
