...
export default function CorrectnessRate({value}: Props) {
  return (
    <div className='flex flex-col items-center justify-center col-start-2 col-end-3 row-start-2 row-end-3 gap-5 rounded-t-full bg-sroom-gray-300 text-sroom-black-400'>
