...
export default function GuideBox({
  ...
  return (
    <button
      type='button'
      onClick={onClick}
      className='flex flex-col relative flex-1 h-[8.5rem] lg:h-40 hover:cursor-pointer lg:hover:h-[17rem] p-4 lg:p-7 transition-all duration-300 bg-white hover:bg-gradient-to-b from-[#222222] to-sroom-black-300 hover:text-white shadow-[0_-2px_5px_1px_rgba(173,173,173,0.3)] text-sroom-black-400 group'
    >
